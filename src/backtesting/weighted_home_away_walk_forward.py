...
from src.models.weighted_home_away_form import WeightedHomeAwayForm
from src.models.weighted_home_away_predictor import WeightedHomeAwayPredictor
...
class WeightedHomeAwayWalkForwardBacktester:
    ...
    def __init__(self):
        ...
        self.weighted_form = WeightedHomeAwayForm()

        self.predictor = WeightedHomeAwayPredictor()
    ...
    def run(self, df):
        ...
        print(
            "Running Weighted Home Away Walk Forward Backtest..."
        )
        ...
        for _, match in df.iterrows():
            ...
            form_difference = (
                self.weighted_form.get_difference(
                    home,
                    away
                )
            )
