...
from src.betting.dynamic_stake import DynamicStake



class DynamicStakeWalkForwardBacktester:
    ...
    def __init__(self):
        ...
        self.dynamic_stake = DynamicStake()
    ...
    def run(
        ...
        print(
            "Running Dynamic Stake Walk Forward Backtest..."
        )
        ...
        for _, match in df.iterrows():
            ...
            if self.value_detector.is_value_bet(
                ...
                stake = (
                    self.dynamic_stake.edge_based(
                        home_value["edge"]
                    )
                )


                self.backtester.stake = stake
