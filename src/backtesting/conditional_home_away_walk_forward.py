...
from src.models.conditional_home_away_filter import ConditionalHomeAwayFilter
...
class ConditionalHomeAwayWalkForwardBacktester:
    ...
    def __init__(self):
        ...
        self.filter = ConditionalHomeAwayFilter(
            odds_threshold=3.0,
            min_form=0.5
        )
    ...
    def run(self, df):
        ...
        print(
            "Running Conditional Home Away Walk Forward Backtest..."
        )
