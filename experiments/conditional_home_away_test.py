...
from src.backtesting.conditional_home_away_walk_forward import (
    ConditionalHomeAwayWalkForwardBacktester
)
...
experiment = Experiment(
    ...
    name="Conditional Home Away Filter Elo",

    model="ConditionalHomeAwayWalkForwardBacktester",

    features=[
        "Elo",
        "TeamForm",
        "ConditionalHomeAwayFilter"
    ],
