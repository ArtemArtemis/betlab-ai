...
from src.backtesting.confidence_calibrated_walk_forward import (
    ConfidenceCalibratedWalkForwardBacktester
)
...
experiment = Experiment(
    ...
    name="Baseline Elo Confidence Calibration",

    model="ConfidenceCalibratedWalkForwardBacktester",
